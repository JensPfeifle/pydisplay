...
UPDATE_INTERVAL = 2.5  # interval betwen display updates in seconds
#HOST = 'http://localhost:19999'
HOST = r'https://jens.pfeifle.com/netdata'
HOST_STR = 'UnJens'
if __name__ == '__main__':
    ...
    while True:
        ...
        active = {}
        for d in disks:
            ddata = netdata_api_request(host=HOST, chart='disk_util.{}'.format(d), after=-10, points=1)  # average over the last 10 seconds
